\begin{figure}
    \begin{mathpar}
        ...
        \\
        \black{\{
        m(x_1~\kw{int},~x_2~\tau\llbracket\eta\rrbracket) \mid
        (\func~(x~t_V[\ov{\alpha}]) ~m(x_1~\kw{int},~x_2~\tau\llbracket\eta\rrbracket) ~t_V~
        ...
        \gray{
            ...
            {\methods_\Delta(t_I\black{[\ov{\tau}]}) = \ov{S}\llbracket\eta\rrbracket}
