...
\newcommand{\Tclo}{\textit{T-\extensionkw}}
...
\newcommand{\ASMclo}{\textit{A-\extensionkw}}

\newcommand{\TExtensionD}[2]{\Tclo(#1)}
\newcommand{\MExtensionD}[2]{\Mclo(#1)}
\newcommand{\ASMExtensionD}[2]{\ASMclo(#1)}
