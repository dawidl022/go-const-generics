...
\begin{figure}
    ...
    \begin{mathpar}
        ...
        \inferrule[t-array-literal-named]
        {
            t_A \ok \\
            \Gamma \vdash \ov{e : t} \\
