...
where type of the index is \kw{int}, and one where the type is an integer
...
integer literal \kw{int} type. This is to stay consistent with current
...
assigning the integer literal to a non-const \kw{int} variable.
