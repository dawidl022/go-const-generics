...
\noindent\begin{minipage}{\linewidth}
    \lstinputlisting[language=Go, tabsize=4, firstline=3, lastline=5]{../../projects/go-generic-array-sizes/interpreters/fgg/typecheck/testdata/self_ref_type_param/recursive_bound_type/recursive_bound_type.go}
\end{minipage}
