...
% \kw{const} type parameters can be used as non-const \kw{int} type values.
% Additionally lone \kw{const} type parameters (but not as part of a more
% complex expression) can be used as \kw{const} type arguments
