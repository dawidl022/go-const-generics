...
\kw{int}, however to keep things simple FGA does not permit this. That is to say,
the only predeclared type name in FGA is \kw{int}, for values of integer type.
No other primitive types (e.g. \kw{bool} or \kw{string}) are defined in FGA.
