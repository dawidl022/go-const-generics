...
\begin{figure}
	\golisting{../../projects/go-generic-array-sizes/benchmarks/benchmarks/semidynamicarray/array.go}
	\caption{``Semi-dynamic'' array with a fixed underlying buffer}
\end{figure}

% Example 3: Ring buffer of static size

\begin{figure}
	\golisting{../../projects/go-generic-array-sizes/benchmarks/benchmarks/ringbuffer/array.go}
	\caption{Double-ended queue (deque) with a fixed underlying buffer}
\end{figure}
